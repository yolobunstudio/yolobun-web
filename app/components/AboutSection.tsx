  ...
  return (
    <section id="about" style={{ position: "relative", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100dvh", padding: "80px 24px", background: "#070707", scrollSnapAlign: "start", isolation: "isolate", overflow: "hidden" }} aria-label="about">
      ...
      <div style={{ maxWidth: 512, textAlign: "center" }}>
        ...
        <p style={{ margin: "0 0 32px", fontSize: "clamp(22px, 4vw, 40px)", fontWeight: 500, lineHeight: 1.2 }}>
          yolobun is a creative collective built on <span className="about-accent">music</span>, <span className="about-accent">community</span>, and <span className="about-accent">culture</span>.
        </p>
        ...
        <div style={{ display: "flex", gap: 20, justifyContent: "center", alignItems: "center" }}>
          <a className="social-link" href="https://www.instagram.com/yolobun.studios" target="_blank" rel="noreferrer" aria-label="Instagram">
            <InstagramIcon />
          </a>
